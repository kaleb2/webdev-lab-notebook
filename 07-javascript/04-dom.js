...
let secondOutputElement = document.createElement("div");
secondOutputElement.setAttribute("class", "output");
section.append(secondOutputElement);

// callback function to handle event
function handleInput(event) {
  secondOutputElement.textContent = userInput2.value;
}
